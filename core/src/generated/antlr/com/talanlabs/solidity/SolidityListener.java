...
public interface SolidityListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SolidityParser#unnamedParameter}.
	 * @param ctx the parse tree
	 */
	void enterUnnamedParameter(SolidityParser.UnnamedParameterContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#unnamedParameter}.
	 * @param ctx the parse tree
	 */
	void exitUnnamedParameter(SolidityParser.UnnamedParameterContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SolidityParser#assemblyRightAssignment}.
	 * @param ctx the parse tree
	 */
	void enterAssemblyRightAssignment(SolidityParser.AssemblyRightAssignmentContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#assemblyRightAssignment}.
	 * @param ctx the parse tree
	 */
	void exitAssemblyRightAssignment(SolidityParser.AssemblyRightAssignmentContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SolidityParser#dataSize}.
	 * @param ctx the parse tree
	 */
	void enterDataSize(SolidityParser.DataSizeContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#dataSize}.
	 * @param ctx the parse tree
	 */
	void exitDataSize(SolidityParser.DataSizeContext ctx);
	/**
	 * Enter a parse tree produced by {@link SolidityParser#linkerSymbol}.
	 * @param ctx the parse tree
	 */
	void enterLinkerSymbol(SolidityParser.LinkerSymbolContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#linkerSymbol}.
	 * @param ctx the parse tree
	 */
	void exitLinkerSymbol(SolidityParser.LinkerSymbolContext ctx);
	/**
