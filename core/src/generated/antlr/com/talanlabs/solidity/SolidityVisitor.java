...
public interface SolidityVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SolidityParser#unnamedParameter}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUnnamedParameter(SolidityParser.UnnamedParameterContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SolidityParser#assemblyRightAssignment}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssemblyRightAssignment(SolidityParser.AssemblyRightAssignmentContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SolidityParser#dataSize}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDataSize(SolidityParser.DataSizeContext ctx);
	/**
	 * Visit a parse tree produced by {@link SolidityParser#linkerSymbol}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLinkerSymbol(SolidityParser.LinkerSymbolContext ctx);
	/**
